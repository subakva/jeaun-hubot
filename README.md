...
weekins is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running weekins Locally

You can test your hubot by running the following.

You can start weekins locally by running:
...
Then you can interact with weekins by typing `weekins help`.

    weekins> weekins help

    weekins> animate me <query> - The same thing as `image me`, except adds a few
